  ...
  global $wpdb;
	...
	*/
    ...
    foreach ($posts as $post) {
      ...
      //$postlist .= '<li><a href="' . get_permalink($post->ID) . '" title="'. $post_title .'" >' . '<div class="img">' . $image . '</div>' . $post_title . '</a>' . '<div class="right">' . $excerpt . '</div>' . "</li>";
	  $postlist .= '<li><div class="img"><a href="' . get_permalink($post->ID) . '" title="'. $post_title .'" >' . $image . '</a></div>' . '<div class="right">' . $excerpt . '</div>' . "</li>" . '<div class="clear"></div>';
    }
		/*
