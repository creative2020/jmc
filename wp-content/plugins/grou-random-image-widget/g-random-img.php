...
addLoadEvent(loadit_<?php echo  str_replace("-","_",$widget_id); ?>); 
		...
		<div class="Grou_image" id="<?php echo $widget_id; ?>frm" style='padding:0; width: <?php echo $Grand_Imgwidth.";"; ?>'			
			...
			<?php  if ($Grand_link!=4) {?>
				...
				?> >
			<?php } ?>
				<img class='Grou_image' alt="wait"   id="<?php echo $widget_id.'img1'; ?>" style="opacity: 0; display: none;" 
			...
			<?php  if ($Grand_link!=4) {?>
				...
				?> >
				<?php } ?>				
				<img class='Grou_image'  alt="wait"   id="<?php echo $widget_id.'img2'; ?>" style="opacity: 0;display: none;"  width="0px" height ="0px"
					src="<?php echo plugins_url('grou-random-image-widget/img/loading.gif') ?>" />  
			...
			<?php  if ($Grand_link!=4) {?>
				...
				?> >				
				<?php } ?>
				<img  class='Grou_image'  id="<?php echo $widget_id.'imgwait'; ?>" alt="wait"
				src="<?php echo plugins_url('grou-random-image-widget/img/loading.gif') ?>" />  
				<?php  if ($Grand_link!=4) echo "</a>"; ?>
		...
		<?php }?>
			...
			<div class="griwNavigation" id="<?php echo $widget_id; ?>nav" align="left"  >
				...
				<table class="RI_Tab" width=<?php echo $Grand_Imgwidth; ?> >
				<tr>
				<td class="RI_Tab">
					...
					<?php }?></td>
				<td style="width:100%" class="RI_Tab" id="<?php echo $widget_id.'navzone'; ?>">
...
?>
		...
		{	
			if (document.getElementById("<?php echo $this->get_field_id( 'Grand_aspect' ); ?>").checked == true)
			{
				...
				//document.getElementById("aspect<?php echo $this->number; ?>").style.height="300px";				
			} else {
		...
		//		document.getElementById("aspect<?php echo $this->number; ?>").style.height="0";			
			}
...
//add_filter('the_content', 'grou_parse');
