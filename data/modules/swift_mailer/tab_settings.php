...
rules.push("if:requires_authentication=yes,required,username,Please enter the username.");
rules.push("if:requires_authentication=yes,required,password,Please enter the password.");
rules.push("if:requires_authentication=yes,required,authentication_procedure,Please indicate the authentication procedure.");
