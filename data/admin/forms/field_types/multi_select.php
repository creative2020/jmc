...
$num_options   = count($field_options);

$head_js =<<< EOF
if (typeof fo_ns == 'undefined')
  var fo_ns = {};
fo_ns.field_type = "multi-select";
...
//if ($num_options == 0)
//  $head_js .= "Event.observe(document, 'dom:loaded', function() { fo_ns.add_rows(\"2\"); });";
...
$page_vars["tabs"]          = $tabs;
$page_vars["field_options"] = $field_options;
$page_vars["field"]         = $field_info;
$page_vars["num_options"]   = $num_options;
$page_vars["edit_field_tab"] = 1;
...
$page_vars["js_messages"]   = array("notify_smart_fill_failure", "notify_smart_fill_failure", "phrase_unknown_field_type_c", "validation_num_rows_to_add", "validation_no_field_group_selected");
